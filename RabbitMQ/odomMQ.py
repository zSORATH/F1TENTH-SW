...
# We need to send orientation, so we use a function to
...
class OdomMQ():
    def __init__(self):
        ...
        self.sub=rospy.Subscriber('/vesc/low_level/ackermann_cmd_mux/output', AckermannDriveStamped, self.drive_callback)   
